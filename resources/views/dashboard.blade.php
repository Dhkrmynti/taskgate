...
@section('hello_name', 'Dashboard')
@section('date_label', 'Overview')
@section('hero_subtitle', 'Monitoring Progress per Batch - Live updates dari setiap fase')
...
<div class="space-y-3">
    ...
    <div class="overflow-hidden rounded-xl border border-slate-200 bg-white p-3 shadow-soft dark:border-brand-darkLine dark:bg-[#161f35]">
        <div class="overflow-x-auto">
            <table class="dataTable progress-table w-full text-left">
                <thead>
                    <tr>
                        <th>Batch Profile</th>
                        <th>
                        ...
                        <tr class="group hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-colors">
                            <td>
                                <div class="flex items-start gap-3">
                                    <span class="batch-id-badge mt-1 shrink-0">
                                        {{ substr($batch->id, -2) }}
                                    </span>
                                    <div class="min-w-0">
                                        <p class="truncate text-sm font-bold text-slate-800 dark:text-white">{{ $batch->id }}</p>
                                        <p class="mt-1 text-[10px] font-medium uppercase tracking-tight text-slate-400 dark:text-slate-500 line-clamp-1">{{ $batch->project_name }}</p>
                                    </div>
                                </div>
                            </td>
